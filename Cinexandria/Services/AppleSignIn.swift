...
final class AppleSignIn: NSObject {
    ...
    func appleSignIn() {
        ...
        authorizationController.presentationContextProvider = UIApplication
            .shared
            .connectedScenes
            .flatMap { ($0 as? UIWindowScene)?.windows ?? [] }
            .last { $0.isKeyWindow }?.rootViewController as? ASAuthorizationControllerPresentationContextProviding
